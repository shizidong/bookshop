 ...
 *
 * <p>Description:HTTP工具类，可以发送HTTP请求 </p>
 *
...
public class HttpUtil {
	 ...
	 * 
	 * @param url发送请求的URL
	 * @param param请求参数，请求参数应该是K-V 的形式。
	 ...
	 * 
	 * @param url发送请求的URL
	 * @param param请求参数，请求参数应该是 name1=value1&name2=value2 的形式。IO
	 * @return URL 所代表远程资源的响应结果
	 */
	 ...
	 * 
	 * @param url发送请求的 URL
	 * @param param请求参数，请求参数应该是 k-v 的形式。
	 * @param isproxy是否使用代理模式
	 * @return 所代表远程资源的响应结果
	 */
